...
import { saveFile2 } from '../actions/bagActions';
...
export default function FileOneScreen(props) {
  ...
  const [name, setName] = useState(file2.name);
  const [desc, setDesc] = useState(file2.desc);
  ...
  const submitHandler = (e) => {
    ...
    props.history.push('/file3');
  };

  return (
    <div>
      <MintRequestSteps step1 step2 step3></MintRequestSteps>
